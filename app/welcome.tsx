...
interface WelcomeScreenProps {
  onSignIn: () => void; // Callback for Sign In
}
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.buttonContainer}>
        <TouchableOpacity style={styles.roundButton} onPress={() => router.push('/sign-in')}>
          <Text style={styles.roundButtonText}>Sign in</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.roundButton} onPress={() => router.push('/sign-up')}>
